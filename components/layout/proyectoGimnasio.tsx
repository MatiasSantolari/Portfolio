...
export function ProyectoGimnasio(){
    ...
    const imgSistGestorGimnasio = [
      `${basePath}/images/projects/sistGestorGimnasio/EER_Diagram.png`,
      `${basePath}/images/projects/sistGestorGimnasio/1-paginainicial.png`,
      `${basePath}/images/projects/sistGestorGimnasio/2-login.png`,
      `${basePath}/images/projects/sistGestorGimnasio/3-maquina_elemento.png`,
      `${basePath}/images/projects/sistGestorGimnasio/4-maquina_elemento_agregar.png`,
      `${basePath}/images/projects/sistGestorGimnasio/5-tipo_clase.png`,
      `${basePath}/images/projects/sistGestorGimnasio/6-tipo_clase_filtrar.png`,
      `${basePath}/images/projects/sistGestorGimnasio/7-tipo_clase_editar_1.png`,
      `${basePath}/images/projects/sistGestorGimnasio/8-tipo_clase_listar_actualizado.png`,
      `${basePath}/images/projects/sistGestorGimnasio/9-cuotas.png`,
      `${basePath}/images/projects/sistGestorGimnasio/10-reportecuotas_antes.png`,
      `${basePath}/images/projects/sistGestorGimnasio/11-reportecuotas_despues.png`,
      `${basePath}/images/projects/sistGestorGimnasio/12-reportecuotas_impresion.png`,
      `${basePath}/images/projects/sistGestorGimnasio/13-clases.png`,
      `${basePath}/images/projects/sistGestorGimnasio/14-reporte_clases.png`,
      `${basePath}/images/projects/sistGestorGimnasio/15-socios.png`,
      `${basePath}/images/projects/sistGestorGimnasio/16-socios_agregar_antes.png`,
      `${basePath}/images/projects/sistGestorGimnasio/17-socios_agregar_despues.png`,
      `${basePath}/images/projects/sistGestorGimnasio/18-ingreso_socio.png`,
      `${basePath}/images/projects/sistGestorGimnasio/19-ingreso_socio_aceptado.png`,
      `${basePath}/images/projects/sistGestorGimnasio/20-ingreso_socio_fallido_antes.png`,
      `${basePath}/images/projects/sistGestorGimnasio/21-ingreso_socio_fallido_despues.png`,
    ]
